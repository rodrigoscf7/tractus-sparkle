...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "prevIA - CONTENT" },
      { property: "og:description", content: "Pipeline de produção de conteúdo com curadoria humana e agentes de IA." },
      { name: "twitter:description", content: "Pipeline de produção de conteúdo com curadoria humana e agentes de IA." },
